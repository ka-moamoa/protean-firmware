...
__shared( uint32_t buffer_output_0[30];
          uint32_t buffer_output_4[30];
          uint32_t buffer_output_8[30];
          uint32_t buffer_output_12[30];
          uint32_t buffer_output_16[30];
          uint32_t buffer_output_20[30];
          uint32_t buffer_output_24[30];
          uint32_t buffer_output_28[30];
          uint32_t buffer_output_32[30];
          uint32_t buffer_output_36[30];
          uint32_t buffer_output_40[30];
          uint32_t buffer_output_44[30];
          uint32_t buffer_output_48[30];
          uint32_t buffer_output_52[30];
          uint32_t buffer_output_56[30];
          uint32_t buffer_output_60[30];
