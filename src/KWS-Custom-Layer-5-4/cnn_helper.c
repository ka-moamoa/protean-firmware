...
{ 
  memcpy32((uint32_t *) 0x50402000, layer_1_input_0, 30);
  memcpy32((uint32_t *) 0x5040a000, layer_1_input_4, 30);
  memcpy32((uint32_t *) 0x50412000, layer_1_input_8, 30);
  memcpy32((uint32_t *) 0x5041a000, layer_1_input_12, 30);
  memcpy32((uint32_t *) 0x50802000, layer_1_input_16, 30);
  memcpy32((uint32_t *) 0x5080a000, layer_1_input_20, 30);
  memcpy32((uint32_t *) 0x50812000, layer_1_input_24, 30);
  memcpy32((uint32_t *) 0x5081a000, layer_1_input_28, 30);
  memcpy32((uint32_t *) 0x50c02000, layer_1_input_32, 30);
  memcpy32((uint32_t *) 0x50c0a000, layer_1_input_36, 30);
  memcpy32((uint32_t *) 0x50c12000, layer_1_input_40, 30);
  memcpy32((uint32_t *) 0x50c1a000, layer_1_input_44, 30);
  memcpy32((uint32_t *) 0x51002000, layer_1_input_48, 30);
  memcpy32((uint32_t *) 0x5100a000, layer_1_input_52, 30);
  memcpy32((uint32_t *) 0x51012000, layer_1_input_56, 30);
  memcpy32((uint32_t *) 0x5101a000, layer_1_input_60, 30);
