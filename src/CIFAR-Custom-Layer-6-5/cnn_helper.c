...
{ 
  memcpy32((uint32_t *) 0x50400000, layer_1_input_0, 128);
  memcpy32((uint32_t *) 0x50408000, layer_1_input_4, 128);
  memcpy32((uint32_t *) 0x50410000, layer_1_input_8, 128);
  memcpy32((uint32_t *) 0x50418000, layer_1_input_12, 128);
  memcpy32((uint32_t *) 0x50800000, layer_1_input_16, 128);
  memcpy32((uint32_t *) 0x50808000, layer_1_input_20, 128);
  memcpy32((uint32_t *) 0x50810000, layer_1_input_24, 128);
  memcpy32((uint32_t *) 0x50818000, layer_1_input_28, 128);
  memcpy32((uint32_t *) 0x50c00000, layer_1_input_32, 128);
  memcpy32((uint32_t *) 0x50c08000, layer_1_input_36, 128);
  memcpy32((uint32_t *) 0x50c10000, layer_1_input_40, 128);
  memcpy32((uint32_t *) 0x50c18000, layer_1_input_44, 128);
  memcpy32((uint32_t *) 0x51000000, layer_1_input_48, 128);
  memcpy32((uint32_t *) 0x51008000, layer_1_input_52, 128);
  memcpy32((uint32_t *) 0x51010000, layer_1_input_56, 128);
  memcpy32((uint32_t *) 0x51018000, layer_1_input_60, 128);
