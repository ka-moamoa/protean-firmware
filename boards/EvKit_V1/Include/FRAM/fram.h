...
#define SPI                     MXC_SPI1
#define SPI_SLAVE               0
#define NVM_RESET_INT_PORT      MXC_GPIO2
#define NVM_RESET_INT_PIN       MXC_GPIO_PIN_7
#define NVM_RESET_STATUS_PORT   MXC_GPIO0
#define NVM_RESET_STATUS_PIN    MXC_GPIO_PIN_3
