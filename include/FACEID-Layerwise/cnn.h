...
/*
  SUMMARY OF OPS
  Hardware: 7,680 ops (0 macc; 0 comp; 7,680 add; 0 mul; 0 bitwise)
    Layer 0: 7,680 ops (0 macc; 0 comp; 7,680 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 0 bytes out of 442,368 bytes total (0%)
