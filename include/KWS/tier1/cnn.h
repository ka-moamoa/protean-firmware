...
/*
  SUMMARY OF OPS
  Hardware: 5,376 ops (5,376 macc; 0 comp; 0 add; 0 mul; 0 bitwise)
    Layer 0: 5,376 ops (5,376 macc; 0 comp; 0 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 5,376 bytes out of 442,368 bytes total (1%)
